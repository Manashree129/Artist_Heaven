# Generated by Django 5.1.6 on 2025-03-07 08:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('PAINTS & MEDIUMS', 'Paints & Mediums'), ('SURFACES & TOOLS', 'Surfaces & Tools'), ('CREATIVE TOOLS', 'Creative Tools')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity', models.PositiveIntegerField(default=1)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.tool')),
            ],
        ),
    ]
